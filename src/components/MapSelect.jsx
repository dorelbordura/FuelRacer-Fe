...
export default function MapSelect({ maps = [], onSelect }) {
  ...
  return (
    ...
    >
      {/* 🔹 Level / XP HUD */}
      <div className="absolute top-6 left-6 bg-black/40 backdrop-blur-md p-5 rounded-2xl border border-red-400/70 shadow-[0_0_25px_rgba(255,0,0,0.6)] w-72 animate-fadeIn">
        <div className="flex items-center space-x-4">
          {/* Level Badge */}
          <div className="relative w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-orange-700 shadow-[0_0_20px_rgba(255,0,0,0.7)]">
            <span className="text-xl font-bold text-white">{level}</span>
            <div className="absolute inset-0 rounded-full border-2 border-red-400 animate-spin-slow opacity-70" />
          </div>

          {/* XP Info */}
          <div className="flex flex-col flex-1">
            <span className="font-semibold text-red-300 text-lg tracking-wide">
              Racer Level
            </span>
            ...
            <div className="mt-2 w-full bg-gray-800/70 rounded-full h-3 overflow-hidden shadow-inner">
              <div
                className="h-3 rounded-full bg-gradient-to-r from-red-400 via-orange-500 to-yellow-500 shadow-[0_0_20px_rgba(0,255,255,0.8)] animate-pulse"
      ...
      <button
        ...
        disabled={locked}
        className={`mt-12 px-10 py-4 rounded-xl font-bold text-xl tracking-wide shadow-[0_0_20px_rgba(255,0,0,0.7)] transition transform neon-glow ${
          locked
